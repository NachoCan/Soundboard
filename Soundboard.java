...
public class Soundboard
{
	...
	{
		//Create a new frame
		JFrame soundboard1 = new JFrame();
        
        //make sure the program exits when the frame closes
        soundboard1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
		//set the size of the frame
        soundboard1.setSize(900, 500);
		...
		JButton button2 = makeSoundboardButton("leonard.jpg","Rubenstein.wav");
		button2.setPreferredSize(new Dimension(400,400));
		//create a JPanel for the button
		JPanel soundboard2 = new JPanel();
		
		//add the button to a JPanel
		soundboard2.add(button);
		soundboard2.add(button2);
		
		//add the panel to the content pane of the frame
		soundboard1.getContentPane().add(soundboard2);
		
		//make sure the JFrame is visible
		soundboard1.setVisible(true);
	}
